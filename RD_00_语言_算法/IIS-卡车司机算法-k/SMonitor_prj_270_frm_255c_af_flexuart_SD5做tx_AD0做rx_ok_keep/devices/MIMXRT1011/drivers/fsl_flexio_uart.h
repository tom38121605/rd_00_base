...
extern volatile uint8_t flg_flrx;
extern volatile uint8_t iflrxcount;
extern volatile uint8_t iflrxcount2;
extern volatile uint8_t iflrxdata[10];
extern volatile uint8_t iflrxdata2[10];
