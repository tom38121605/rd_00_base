...
void ClockSetToLowSpeedRun(void)     //org
{
    // CORE CLK mux to 24M before reconfigure PLLs
    SwitchSystemClocks(LPM_PowerModeLowPowerRun);
...
////{
//////    // CORE CLK mux to 24M before reconfigure PLLs
//////    SwitchSystemClocks(LPM_PowerModeLowPowerRun);    //err

////    /* Init SYS PLL */
//////    CLOCK_InitSysPll(&sysPllConfig);   //ok

//////    /* Deinit SYS PLL PFD 0 1 */
//////    CLOCK_DeinitSysPfd(kCLOCK_Pfd0);
//////    CLOCK_DeinitSysPfd(kCLOCK_Pfd1);   //err
//////    /* Init System pfd2. */
//////    CLOCK_InitSysPfd(kCLOCK_Pfd2, 24);     //err
//////    /* Init System pfd3. */
//////    CLOCK_InitSysPfd(kCLOCK_Pfd3, 24);   //err

////   
//////    /* Deinit USB1 PLL */
//////    CLOCK_DeinitUsb1Pll();   //err

//////    /* Deinit USB1 PLL PFD 0 1 2 3 */
//////    CLOCK_DeinitUsb1Pfd(kCLOCK_Pfd0);   //err
//////    CLOCK_DeinitUsb1Pfd(kCLOCK_Pfd1);    //err
//////    CLOCK_DeinitUsb1Pfd(kCLOCK_Pfd2);     //err

//////    CLOCK_DeinitUsb1Pfd(kCLOCK_Pfd3);    //?

////    /* Deinit AUDIO PLL */
////    //--CLOCK_DeinitAudioPll();    //--chg    
////    /* Init AUDIO PLL */
////    //CLOCK_InitAudioPll(&audioPllConfig);   //--add  //ok
////    

//////    /* Deinit ENET PLL */
//////    CLOCK_DeinitEnetPll();        //err

////    SwitchSystemClocks(LPM_PowerModeLowSpeedRun);  //ok
////}
